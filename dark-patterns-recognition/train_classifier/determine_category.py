...
# Save vectorizer and TF-IDF transformer together
vectorizer_tfidf = Pipeline([
    ('vect', text_clf.named_steps['vect']),
    ('tfidf', text_clf.named_steps['tfidf'])
])
joblib.dump(vectorizer_tfidf, 'category_vectorizer_bn.joblib')

# Save classifier separately
classifier = text_clf.named_steps['clf']
joblib.dump(classifier, 'category_classifier_bn.joblib')
