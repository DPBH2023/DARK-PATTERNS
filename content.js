...
function scrape() {
  ...
  if (document.getElementById("darkdetect_count")) {
    return;
  }
...
function highlight(element, type) {
  ...
  body.classList.add("darkdetect-highlight-body");
...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
  if (request.message === "analyze_site") {
    ...
    let element = document.getElementById("darkdetect_count");
    if (element) {
